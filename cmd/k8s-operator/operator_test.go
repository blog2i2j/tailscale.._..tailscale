...
func TestTailscaledConfigfileHash(t *testing.T) {
	...
	o := configOpts{
		...
		hostname:        "default-test",
		clusterTargetIP: "10.20.30.40",
		confFileHash:    "d4955ef06422c09b01e1beb8fc79728ee56839e998df42d1d4ce424979f26404",
		app:             kubetypes.AppIngressProxy,
	}
	...
	o.confFileHash = "9af91b91e158c31387b684201953824e7a0244e32e12a078f0e11535f78194e8"
	expectReconciled(t, sr, "default", "test")
	expectEqual(t, fc, expectedSTS(t, fc, o), nil)
}
